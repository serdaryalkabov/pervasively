    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        h1 { font-family:'Manrope',sans-serif; font-size:clamp(36px,4.8vw,64px); font-weight:500; line-height:1.05; letter-spacing:-1.5px; color:var(--text); }
        h2 { font-family:'Manrope',sans-serif; font-size:clamp(28px,3.5vw,46px); font-weight:500; letter-spacing:-1px; line-height:1.1; color:var(--text); margin-bottom:56px; }
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 56px", height: 68, borderBottom: `1px solid ${scrolled ? "rgba(255,255,255,0.06)" : "transparent"}`, background: scrolled ? "rgba(8,13,16,0.85)" : "transparent", backdropFilter: scrolled ? "blur(20px)" : "none", transition: "all .3s" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 40 }}>
          <a href="#" style={{ fontFamily: "'Manrope',sans-serif", fontSize: 19, fontWeight: 500, color: "var(--text)", textDecoration: "none", letterSpacing: -0.5 }}>Pervasive<span style={{ color: "var(--teal-bright)" }}>ly</span></a>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <Link href="/sign-in" style={{ display: "inline-flex", alignItems: "center", gap: 6, fontFamily: "'Manrope',sans-serif", fontSize: 13, fontWeight: 500, color: "#fff", background: "var(--teal)", border: "none", borderRadius: 8, padding: "9px 20px", cursor: "pointer", textDecoration: "none" }}>Sign in <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></Link>
        </div>
      </nav>

      {/* HERO */}
      <section className="hero-section" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", padding: "88px 56px 40px", overflow: "hidden", zIndex: 1 }}>
        <div className="hero-inner" style={{ maxWidth: 1100, width: "100%", margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 64 }}>

          {/* Left: text */}
          <div style={{ maxWidth: 560, flex: "1 1 auto" }}>
            <div style={{ opacity: 0, animation: "fadeUp .6s .18s forwards" }}>
              <p style={{ fontFamily: "'Inter',sans-serif", fontSize: 12, fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--teal-bright)", marginBottom: 20 }}>Content engine for solopreneurs</p>
              <h1 style={{ textAlign: "left", marginBottom: 24 }}>Your product<br />deserves to be<br /><span className="accent">seen.</span></h1>
            </div>
            <p style={{ fontSize: 16, fontWeight: 300, lineHeight: 1.7, color: "var(--muted)", maxWidth: 460, marginBottom: 36, opacity: 0, animation: "fadeUp .6s .32s forwards" }}>
              Turn your product brief into a full week of platform-ready posts: Twitter/X, Instagram, LinkedIn. No prompting, no blank page. Just post.
            </p>
            <div style={{ opacity: 0, animation: "fadeUp .6s .46s forwards", display: "flex", alignItems: "center", gap: 20 }}>
              <Link href="/sign-up" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "13px 28px", background: "var(--teal)", color: "#fff", textDecoration: "none", fontFamily: "'Inter',sans-serif", fontSize: 14, fontWeight: 500, borderRadius: 10, transition: "background .2s" }}>
                Start for free
              ...
              <p style={{ fontSize: 12, color: "var(--muted2)" }}>3 free credits, no card required</p>
            </div>
          </div>
          ...
          <div className="hero-right" style={{ flex: "0 0 380px", display: "flex", flexDirection: "column", gap: 12, opacity: 0, animation: "fadeUp .6s .5s forwards" }}>
            {[
              { platform: "Twitter / X", day: "Day 1", text: "Most solopreneurs spend 80% of their time building and 0% telling people about it. That gap is what I built Pervasively to close." },
              { platform: "LinkedIn", day: "Day 3", text: "Six months ago I was writing every post by hand. Two hours on a good week. Now it takes 10 minutes, and the posts actually sound like me." },
              { platform: "Instagram", day: "Day 5", text: "Shipped a new feature last night. Nobody saw it. Sound familiar? Your product deserves an audience." },
            ].map((card, i) => (
              <div key={i} style={{ background: "var(--bg2)", border: "1px solid var(--border)", borderRadius: 14, padding: "16px 18px", opacity: 1 - i * 0.18, transform: `translateY(${i * 4}px)` }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
                  <span style={{ fontSize: 11, fontWeight: 500, color: "var(--teal-bright)", letterSpacing: "0.06em", textTransform: "uppercase" }}>{card.platform}</span>
                  <span style={{ fontSize: 10, color: "var(--muted2)", letterSpacing: "0.05em" }}>{card.day}</span>
                </div>
                <p style={{ fontSize: 13, color: "var(--muted)", lineHeight: 1.65, fontWeight: 300 }}>{card.text}</p>
              </div>
            ))}
          </div>
      ...
      <div className="stats-grid" style={{ position: "relative", zIndex: 1, display: "grid", gridTemplateColumns: "repeat(3,1fr)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)" }}>
        {[
          ...
          <div key={i} className={`stat reveal${i > 0 ? ` reveal-d${i}` : ""}`} style={{ padding: "52px 56px", borderRight: i < 2 ? "1px solid var(--border)" : "none" }}>
            <div style={{ fontFamily: "'Manrope',sans-serif", fontSize: 52, fontWeight: 500, letterSpacing: -1.5, color: "var(--text)", lineHeight: 1, marginBottom: 8 }}>{s.num}<span style={{ color: "var(--teal-bright)" }}>{s.unit}</span></div>
      ...
      <section className="section" style={{ position: "relative", zIndex: 1, padding: "100px 56px" }}>
        <div className="problem-banner reveal" style={{ position: "relative", border: "1px solid var(--border)", borderRadius: 20, background: "var(--bg2)", padding: "52px 64px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, overflow: "hidden" }}>
          ...
          <div>
            <div style={{ fontFamily: "'Manrope',sans-serif", fontSize: 10, fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 14, display: "flex", alignItems: "center", gap: 8, color: "#9C6060" }}>
              <span style={{ display: "inline-block", width: 6, height: 6, borderRadius: "50%", background: "#9C6060" }} />The problem
            </div>
            <h3 style={{ fontFamily: "'Manrope',sans-serif", fontSize: 22, fontWeight: 500, letterSpacing: -0.5, marginBottom: 16, color: "var(--text)" }}>You're shipping. Nobody knows.</h3>
          ...
          <div>
            <div style={{ fontFamily: "'Manrope',sans-serif", fontSize: 10, fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 14, display: "flex", alignItems: "center", gap: 8, color: "var(--teal-bright)" }}>
              <span style={{ display: "inline-block", width: 6, height: 6, borderRadius: "50%", background: "var(--teal-bright)" }} />The solution
            </div>
            <h3 style={{ fontFamily: "'Manrope',sans-serif", fontSize: 22, fontWeight: 500, letterSpacing: -0.5, marginBottom: 16, color: "var(--text)" }}>Your product becomes content.</h3>
      ...
      <section className="section" id="how" style={{ position: "relative", zIndex: 1, padding: "0 56px 100px" }}>
        <div className="section-eyebrow reveal" style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
          ...
          <span style={{ fontFamily: "'Manrope',sans-serif", fontSize: 11, fontWeight: 500, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--teal-bright)" }}>How it works</span>
        </div>
        ...
        <div className="steps-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 1, background: "var(--border)", border: "1px solid var(--border)", borderRadius: 20, overflow: "hidden" }}>
          {[
            ...
            <div key={s.num} className={`step reveal${s.delay}`} data-num={s.num} style={{ background: "var(--bg)", padding: "44px 36px", transition: "background .3s", position: "relative", overflow: "hidden" }}
              ...
              <div style={{ fontFamily: "'Manrope',sans-serif", fontSize: 10, fontWeight: 500, letterSpacing: "0.12em", color: "var(--teal-bright)", marginBottom: 20 }}>{s.idx}</div>
              ...
              <div style={{ fontFamily: "'Manrope',sans-serif", fontSize: 18, fontWeight: 500, color: "var(--text)", marginBottom: 12, letterSpacing: -0.3 }}>{s.title}</div>
      ...
      <section className="section" style={{ position: "relative", zIndex: 1, padding: "80px 56px 100px", borderTop: "1px solid var(--border)" }}>
        <div className="section-eyebrow reveal" style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
          <div style={{ width: 20, height: 1, background: "var(--teal-bright)" }} />
          <span style={{ fontFamily: "'Manrope',sans-serif", fontSize: 11, fontWeight: 500, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--teal-bright)" }}>Features</span>
        </div>
        ...
        <div className="features-grid" style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 16 }}>
          ...
          <div className="feature-card feature-large reveal" style={{ background: "var(--bg2)", border: "1px solid var(--border)", borderRadius: 16, padding: 36, transition: "border-color .3s,background .3s", position: "relative", overflow: "hidden", gridColumn: "span 2", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 40, alignItems: "center" }}
            ...
            <div>
              ...
              <div style={{ fontFamily: "'Manrope',sans-serif", fontSize: 17, fontWeight: 500, color: "var(--text)", letterSpacing: -0.3, marginBottom: 10 }}>Content DNA — set it once</div>
            ...
            <div style={{ background: "var(--bg3)", border: "1px solid var(--border)", borderRadius: 12, padding: 20, minHeight: 160, display: "flex", flexDirection: "column", gap: 10 }}>
              {[{ dot: "#2AA5C0", tag: "Voice", tagStyle: { background: "var(--teal-dim)", color: "var(--teal-bright)", border: "1px solid var(--border-teal)" } }, { dot: "#3DAB7A", tag: "Audience", tagStyle: { background: "rgba(61,171,122,0.12)", color: "#3DAB7A", border: "1px solid rgba(61,171,122,0.2)" } }, { dot: "#C4974A", tag: "Story", tagStyle: { background: "rgba(196,151,74,0.1)", color: "#C4974A", border: "1px solid rgba(196,151,74,0.2)" } }].map((r, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", background: "var(--bg2)", border: "1px solid var(--border)", borderRadius: 8 }}>
                  ...
                  <span style={{ fontFamily: "'Manrope',sans-serif", fontSize: 10, fontWeight: 500, padding: "2px 8px", borderRadius: 4, letterSpacing: "0.06em", ...r.tagStyle }}>{r.tag}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {[
            ...
            <div key={i} className={`feature-card reveal${f.delay}`} style={{ background: "var(--bg2)", border: "1px solid var(--border)", borderRadius: 16, padding: 36, transition: "border-color .3s,background .3s", position: "relative", overflow: "hidden" }}
              ...
              <div style={{ fontFamily: "'Manrope',sans-serif", fontSize: 17, fontWeight: 500, color: "var(--text)", letterSpacing: -0.3, marginBottom: 10 }}>{f.title}</div>
      ...
      <section className="section" id="platforms" style={{ position: "relative", zIndex: 1, padding: "80px 56px 100px", borderTop: "1px solid var(--border)" }}>
        <div className="section-eyebrow reveal" style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
          <div style={{ width: 20, height: 1, background: "var(--teal-bright)" }} />
          <span style={{ fontFamily: "'Manrope',sans-serif", fontSize: 11, fontWeight: 500, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--teal-bright)" }}>Platform coverage</span>
        </div>
        ...
        <div className="platforms-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 16 }}>
          {[
            ...
            <div key={i} className={`platform-card reveal${p.delay}`} style={{ background: "var(--bg2)", border: "1px solid var(--border)", borderRadius: 18, padding: "36px 32px", transition: "border-color .3s,background .3s,transform .3s", position: "relative", overflow: "hidden" }}
              ...
              <div style={{ fontFamily: "'Manrope',sans-serif", fontSize: 17, fontWeight: 500, color: "var(--text)", marginBottom: 10, letterSpacing: -0.3 }}>{p.name}</div>
      ...
      <section className="section" id="pricing" style={{ position: "relative", zIndex: 1, padding: "80px 56px 100px", borderTop: "1px solid var(--border)" }}>
        <div className="section-eyebrow reveal" style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
          <div style={{ width: 20, height: 1, background: "var(--teal-bright)" }} />
          <span style={{ fontFamily: "'Manrope',sans-serif", fontSize: 11, fontWeight: 500, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--teal-bright)" }}>Pricing</span>
        </div>
          ...
          <div className="pricing-header" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", background: "var(--bg2)", borderBottom: "1px solid var(--border)" }}>
            {[
              ...
              <div key={i} style={{ padding: "28px 32px", borderRight: i < 2 ? "1px solid var(--border)" : "none", position: "relative", background: p.featured ? "var(--bg3)" : undefined, borderTop: p.featured ? "2px solid var(--teal-bright)" : undefined }}>
                {p.featured && <div style={{ position: "absolute", top: -1, left: "50%", transform: "translateX(-50%)", background: "linear-gradient(90deg,var(--teal),var(--teal-bright))", color: "#fff", fontFamily: "'Manrope',sans-serif", fontSize: 9, fontWeight: 500, letterSpacing: "0.10em", textTransform: "uppercase", padding: "3px 12px", borderRadius: "0 0 8px 8px" }}>Most popular</div>}
                <div style={{ fontFamily: "'Manrope',sans-serif", fontSize: 11, fontWeight: 500, letterSpacing: "0.10em", textTransform: "uppercase", color: "var(--teal-bright)", marginBottom: 14 }}>{p.name}</div>
                <div style={{ display: "flex", alignItems: "baseline", gap: 3, marginBottom: 4 }}>
                  <span style={{ fontFamily: "'Manrope',sans-serif", fontSize: 18, fontWeight: 500, color: "var(--muted)" }}>$</span>
                  <span style={{ fontFamily: "'Manrope',sans-serif", fontSize: 44, fontWeight: 500, letterSpacing: -2, color: "var(--text)", lineHeight: 1 }}>{p.price}</span>
                </div>
          ...
          <div className="pt-cta-row-wrap pricing-cta-row" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)" }}>
            {[false, true, false].map((featured, i) => (
              <div key={i} style={{ padding: "20px 32px", borderRight: i < 2 ? "1px solid var(--border)" : "none", background: featured ? "var(--bg3)" : "var(--bg2)" }}>
                <Link href="/sign-up" style={{ display: "block", padding: "11px 0", background: featured ? "var(--teal)" : "transparent", border: `1px solid ${featured ? "var(--teal)" : "var(--border-teal)"}`, borderRadius: 10, color: featured ? "#fff" : "var(--teal-bright)", fontFamily: "'Manrope',sans-serif", fontSize: 13, fontWeight: 500, cursor: "pointer", width: "100%", textAlign: "center", textDecoration: "none" }}>Sign up free</Link>
              </div>
            ))}
          </div>
          <div className="mobile-cta-row" style={{ display: "none", padding: "20px 32px", background: "var(--bg2)", borderTop: "1px solid var(--border)" }}>
            <Link href="/sign-up" style={{ display: "block", padding: "11px 0", background: "var(--teal)", border: "1px solid var(--teal)", borderRadius: 10, color: "#fff", fontFamily: "'Manrope',sans-serif", fontSize: 13, fontWeight: 500, textAlign: "center", textDecoration: "none" }}>Sign up free</Link>
          </div>
          <div style={{ background: "var(--bg2)", padding: "24px 32px", borderTop: "1px solid var(--border)" }}>
            <div style={{ fontFamily: "'Manrope',sans-serif", fontSize: 10, fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--muted2)", marginBottom: 16 }}>Everything included in all plans</div>
      ...
      <div style={{ position: "relative", zIndex: 1, margin: "0 56px 100px", border: "1px solid var(--border-teal)", borderRadius: 24, background: "linear-gradient(135deg,rgba(25,97,117,0.14) 0%,rgba(8,13,16,0) 60%)", padding: "80px 72px", overflow: "hidden", textAlign: "center" }} className="reveal">
        ...
        <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 20 }}>
          ...
          <p style={{ fontSize: 16, color: "var(--muted)", maxWidth: 480, lineHeight: 1.65 }}>Pervasively turns your product knowledge into a full week of content: Twitter, LinkedIn, and Instagram — in under 10 minutes.</p>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12, marginTop: 8 }}>
            <Link href="/sign-up" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "16px 40px", background: "var(--teal)", color: "#fff", textDecoration: "none", fontFamily: "'Manrope',sans-serif", fontSize: 15, fontWeight: 500, borderRadius: 14, letterSpacing: 0.02 }}>
